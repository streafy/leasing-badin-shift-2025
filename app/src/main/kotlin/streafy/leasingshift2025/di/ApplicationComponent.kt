...
import streafy.leasingshift2025.features.cardetails.di.CarDetailsModule
...
@ApplicationScope
@Component(modules = [NavigationModule::class, ViewModelModule::class, NetworkModule::class, CarsCatalogModule::class, CarDetailsModule::class])
